...
/* provided dependency */ var lucky_wheel_ConceptSGMTheme = __webpack_require__(4558)["ConceptSGMTheme"];
/* provided dependency */ var lucky_wheel_ConceptSGMSettings = __webpack_require__(4558)["ConceptSGMSettings"];
...
class LuckyWheel {
  constructor(settings) {
    ...
    (0,defineProperty/* default */.Z)(this, "handleSubmit", async () => {
      ...
      if (validated) {
        ...
        if (res.ok) {
          ...
          this.toggleLoading(false);
          lucky_wheel_ConceptSGMTheme.Notification.show({
    ...
    if (this.settings?.display_on === 'home_only' && lucky_wheel_ConceptSGMSettings.template === 'index') {
      this.init();
    }
